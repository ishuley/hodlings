...
abstract class Asset {
  ...
  Future<void> _initMarketCap({String vsTicker = 'usd'}) async {
    marketCap = await _getMarketCap(vsTicker: vsTicker);
  }
  ...
  Future<double> _getMarketCap({String vsTicker = 'usd'}) async {
